...
| Тег | Значение |
| --- | --- |
| `1.12.0-build1-alpine`, `…-debian` | Неизменяемый — точная версия Angie и упаковка. **Фиксируйте его.** |
...
| `*-unprivileged` | Rootless-вариант; суффикс ко всем тегам выше, кроме `latest` (например, `alpine-unprivileged`, `1.12.0-build1-alpine-unprivileged`). |
