...
| `IMAGE_VERSION` | `dev` | Packaging version stamped into `org.opencontainers.image.version` (the image tag minus the variant suffix, e.g. `1.12.1-build1`). Set by the release workflow. |
